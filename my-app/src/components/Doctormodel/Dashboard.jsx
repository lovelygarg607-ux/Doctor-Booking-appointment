...
const Dashboard = () => {
   ...
   const Dispatch = useDispatch()
    ...
    //         const response = await axios.get(`/Hospital/doctor/getdoctor/${localStorage.getItem("loginid")}`)
    //        if(response.data.status==="success"){


    //         return response.data. existingdoctor;
    //        }
    ...
    // useEffect(()=>{
    //   getdata().then((data)=> setProfiledata(data))
    // }, [])
                ...
                <main class="main-content">
                    ...
                    <div class="dashboard-container">
                        <div class="welcome-banner">
                            ...
                            <h1>Good Morning, <b>{profileData?.doctorname}</b></h1>
