...
const PatientSidebar = () => {
  ...
  const toggledropdown = () => {
    ...
    const handelLogout = () => {
        ...
        Dispatch(setpatientProfileData(null))
          ...
          <li className={active === "doctor" ? "sidebar-menu-item active" : "sidebar-menu-item"} onClick={() => setactive(active === "doctor" ? "" : "doctor")}>
            <a href="#">
              ...
              transition: "0.3s linear"
                ...
                <li className={active === "doctorlist" ? "active" : ""} onClick={() => setactive(active === "doctorlist" ? "" : "doctorlist")}>
                <Link to={`/doctorlist`}>Doctorslist</Link>
              </li>
            </ul>
        ...
        <div className="sidebar-menu logout-link">
          <li className="sidebar-menu-item">
            <a href="#">
              ...
              <span ><Link to ="/login" onClick={handelLogout} >Logout</Link></span>
            </a>
          </li>
        </div>
      </div>
